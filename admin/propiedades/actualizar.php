    ...
    <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST'){
            if (isset($_POST['formulario-crear']) && $_POST['formulario-crear'] === 'Formulario_Alumno') {
                ...
                $estatus = mysqli_real_escape_string($db, $_POST['estatus-alumno']);

                $queryAlumno = "UPDATE ALUMNOS SET
                    ...
                    ESTATUS = '$estatus'  WHERE EXPEDIENTE_ALUMNO = ".$expediente;
            ...
            if (isset($_POST['formulario-crear']) && $_POST['formulario-crear'] === 'Formulario_Docente'){
                ...
                if (empty($horarios_grupo)){
                    $errores [] = "Debes seleccionar el horario";
                } 
                ...
                $queryDocente = "UPDATE DOCENTES SET
                    ...
                    HORARIO_DOCENTE = '$stringHorario'
                    WHERE EXPEDIENTE_DOCENTE = $expediente ;";
            ...
            if (isset($_POST['formulario-crear']) && $_POST['formulario-crear'] === 'Formulario_Materia'){
                ...
                $queryMateria = "UPDATE MATERIAS SET
            ...
            if (isset($_POST['formulario-crear']) && $_POST['formulario-crear'] === 'Formulario_Clase'){
                ...
                $queryClase = "UPDATE CLASES SET
                    NUM_GRUPO = $grupos,
                    ID_CARRERA = $carreras,
                    CLAVE_MATERIA = $materias,
                    EXPEDIENTE_DOCENTE = $expediente,
                    SALON = '$salon',
                    HORARIO = '$horario_clase'
                    WHERE ID_CLASE = $id_campos;";
            ...
            if (isset($_POST['formulario-crear']) && $_POST['formulario-crear'] === 'Formulario_Grupo'){
                ...
                $queryGrupo = "UPDATE GRUPOS SET
                    ID_CARRERA = $carreras,
                    TOTAL_ALUMNOS = $num_alumnos,
                    HORARIO = '$stringHorario'
                    WHERE NUM_GRUPO = $num_grupos;";
            ...
            if (isset($_POST['formulario-crear']) && $_POST['formulario-crear'] === 'Formulario_Carrera'){
                ...
                $queryCarrera = "UPDATE CARRERAS SET
                    CLAVE_CARRERA = '$clave_materia',
                    NOMBRE = '$nombre'
                    WHERE ID_CARRERA = $id_campos;";
            ...
            if (isset($_POST['formulario-crear']) && $_POST['formulario-crear'] === 'Formulario_Blog'){
                ...
                $queryBlog = "UPDATE BLOG SET
                    TITULO = '$nombre',
                    DESCRIPCION_BREVE = '$descripcion1',
                    DESCRIPCION_DETALLADA = '$descripcion2',
                    ENLACE ='$enlace'
                    WHERE ID_BLOG = $id_campos";
            ...
            if (isset($_POST['formulario-crear']) && $_POST['formulario-crear'] === 'Formulario_MD'){
                ...
                $queryMD = "UPDATE MAESTRIAS_DOCTORADOS SET
                    NOMBRE = '$nombre',
                    DESCRIPCION_BREVE = '$descripcion1',
                    CUPO = $cupo,
                    FACULTAD = '$facultad',
                    TELEFONO = $telefono
                    WHERE ID_MD = $id_campos;";
...
<body>
    ...
    <div class="contenedor-principales">
            ...
            <form class="formulario form-principales" method="POST">
                ...
                <fieldset class="contenedor-contacto campo-principales">
                    ...
                    <div class="campo">
                        ...
                        <select name="estatus-alumno" class="campo__field">
                ...
                <div class="pass">
                    <input type="submit" value="Actualizar" class="pass-boton">
                </div>
            </form>
        </div>
        ...
        <?php elseif(intval($exito) === 2):?>
            <p class="alerta exito">Docente actualizado correctamente</p>
        <?php elseif(intval($exito) === 3):?>
            <p class="alerta exito">Materia actualizada correctamente</p>
        <?php elseif(intval($exito) === 4):?>
            <p class="alerta exito">Clase actualizada correctamente</p>
        <?php elseif(intval($exito) === 5):?>
            <p class="alerta exito">Grupo actualizado correctamente</p>
        <?php elseif(intval($exito) === 6):?>
            <p class="alerta exito">Carrera actualizada correctamente</p> 
        <?php elseif(intval($exito) === 7):?>
            <p class="alerta exito">Blog actualizado correctamente</p> 
        <?php elseif(intval($exito) === 8):?>
            <p class="alerta exito">Maestria o Doctorado actualizado correctamente</p>  
        <?php endif;?>
