...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT EXPEDIENTE_ALUMNO, NIP_ALUMNO FROM ALUMNOS WHERE EXPEDIENTE_ALUMNO = ?";
    ...
    if ($expediente_db && password_verify($_POST['nip'], $nip_hash_db)) {
        ...
        $_SESSION['login'] = true;
        header('Location: propiedadesAlumno/principalAlumno.php?expediente='.$expediente);
        exit();
    } else {
